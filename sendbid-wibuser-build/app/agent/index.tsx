...
export default function AgentPanel() {
  ...
  const CARDS = [
    ...
    { key: "float",     icon: "cash-outline",    color: "#FFA500", label: "Float & trésorerie",  desc: "Déclarations consolidées", route: "/admin/reconciliation" },
      ...
      <Screen title="Console Super-Agent" back scroll={false}>
        <ScrollView contentContainerStyle={{ paddingBottom: spacing.xxxl }}>
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 10 }}>
            <Kpi label="Agents actifs" value={kpis?.agents?.active ?? "—"} icon="people-circle" tint="#FFA500" />
            ...
            <Kpi label="Complétés" value={kpis?.transfers?.completed ?? "—"} icon="checkmark-done" tint="#CC7A00" />
