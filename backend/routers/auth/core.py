...
async def register(payload: RegisterIn):
    ...
    # Send email OTP immediately; SMS will be sent after successful email verification
    delivery = await notify_signup_otp(email, phone, email_code, phone_code, payload.full_name, with_sms=False)
    response = {
        "user_id": user_id,
