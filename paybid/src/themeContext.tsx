...
const ThemeCtx = createContext<Ctx>({ mode: "system", setMode: async () => {}, tokens: paybidColors as unknown as typeof lightColors, isDark: false });
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const tokens = (isDark ? paybidDarkColors : paybidColors) as unknown as typeof lightColors;
