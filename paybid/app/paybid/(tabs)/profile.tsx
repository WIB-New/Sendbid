...
export default function PaybidProfile() {
  ...
  const SECTIONS: {
  ...
  }[] = [
    {
      ...
      route: "/paybid/account-info",
      icon: "person-circle",
      tint: paybidColors.primary.base,
    },
    {
      title: "Paramètres",
      subtitle: "Langue, devise locale, sécurité",
      route: "/paybid/settings",
      icon: "settings",
      tint: "#8B5CF6",
    },
    {
      ...
      route: "/paybid/loyalty",
      icon: "trophy",
      tint: "#F59E0B",
    },
    {
      title: "Support",
      subtitle: "Aide, FAQ, conditions, nous contacter",
      route: "/paybid/support",
      icon: "help-circle",
      tint: "#10B981",
    },
  ];
