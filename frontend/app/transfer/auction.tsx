...
const styles = StyleSheet.create({
  ...
  agentCardBest: { borderColor: colors.primary.base, borderWidth: 2 },
  bestBadge: { position: "absolute", top: -8, left: 10, flexDirection: "row", alignItems: "center", backgroundColor: colors.primary.base, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 999 },
  agentAvatar: { width: 32, height: 32, borderRadius: 16, backgroundColor: colors.overlays.primarySoft, alignItems: "center", justifyContent: "center" },
