      ...
      >
        ...
        <LinearGradient colors={[paybidColors.primary.dark, paybidColors.primary.base]} start={{x:0,y:0}} end={{x:1,y:1}} style={[styles.heroCard, shadows.lg]}>
          <View style={styles.heroTopRow}>
            ...
            {/* Toggle dispo */}
            <TouchableOpacity onPress={toggleAvail} style={[styles.statusPill, { backgroundColor: available ? "rgba(16,185,129,0.28)" : "rgba(255,255,255,0.18)" }]}>
              <View style={{ width: 6, height: 6, borderRadius: 3, backgroundColor: available ? "#10B981" : "#9CA3AF", marginRight: 6 }} />
        ...
        <View style={styles.quickRow}>
          <QuickAction icon="qr-code" color="#10B981" label="Scanner" onPress={() => router.push("/paybid/scan" as any)} />
        ...
        <TouchableOpacity activeOpacity={0.85} onPress={() => router.push("/paybid/(tabs)/auctions" as any)} style={{ marginTop: spacing.xl }}>
          <LinearGradient
            colors={hasLiveBids ? ["#10B981", "#04ba28"] : [paybidColors.primary.base, paybidColors.primary.dark]}
